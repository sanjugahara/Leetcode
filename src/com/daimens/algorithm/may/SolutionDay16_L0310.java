 ...
 *
 */
public class SolutionDay16_L0310 {
...
//		}
//		for (int[] edge : edges){
//			adj[edge[0]].add(new Node(edge[1]));
//			adj[edge[1]].add(new Node(edge[0]));
//		}
//		
...
//			for(int leaf : leaves){
//				Node node = adj[leaf].iterator().next();
//				for (int i = 0; i < adj[node.label].size(); i++){
//					if (adj[node.label].get(i).label == leaf){
//						adj[node.label].remove(i);
//					}
//				}
//				if (adj[node.label].size() ==1) newLeaves.add(node.label);
//			}
//			leaves = newLeaves;
//		}
//        return leaves;
//    }
	...
	public static void main(String[] args) {
		SolutionDay16_L0310 day = new SolutionDay16_L0310();
		int[][] edges = {{1,0},{1,2},{1,3}};
		day.findMinHeightTrees(4, edges);
	}
}
