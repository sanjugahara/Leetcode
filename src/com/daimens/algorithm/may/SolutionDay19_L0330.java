 ...
 *         of: 1, 3, 4. Now if we add/patch 2 to nums, the combinations are:
 *         [1], [2], [3], [1,3], [2,3], [1,2,3]. Possible sums are 1, 2, 3, 4,
 ...
 *
 */
public class SolutionDay19_L0330 {
	...
	public static void main(String[] args) {
		SolutionDay19_L0330 day = new SolutionDay19_L0330();
		int[] nums = {1,2,31,33};
		day.minPatches(nums, 2147483647);
