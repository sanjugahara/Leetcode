 ...
 *         becomes s1. For example, “abc” can be obtained from “abdbec” based on
 *         our definition, but it can not be obtained from “acbbe”.
 * 
 *         You are given two non-empty strings s1 and s2 (each at most 100
 *         characters long) and two integers 0 ≤ n1 ≤ 106 and 1 ≤ n2 ≤ 106. Now
 *         consider the strings S1 and S2, where S1=[s1,n1] and S2=[s2,n2]. Find
 *         the maximum integer M such that [S2,M] can be obtained from S1.
 * 
 *         Example:
 * 
 ...
 *
 */
public class SolutionDay26_466 {
