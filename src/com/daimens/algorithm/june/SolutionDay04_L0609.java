 ...
 * 
 *         The output is a list of group of duplicate file paths. For each
 ...
 * 
 *         Example 1: Input: ["root/a 1.txt(abcd) 2.txt(efgh)", "root/c
 *         3.txt(abcd)", "root/c/d 4.txt(efgh)", "root 4.txt(efgh)"] Output:
 *         [["root/a/2.txt","root/c/d/4.txt","root/4.txt"],["root/a/1.txt","root/c/3.txt"]]
 *         Note: No order is required for the final output. You may assume the
 *         directory name, file name and file content only has letters and
 *         digits, and the length of file content is in the range of [1,50]. The
 *         number of files given is in the range of [1,20000]. You may assume no
 *         files or directories share the same name in a same directory. You may
 *         assume each given directory info represents a unique directory.
 ...
 *         how will you search files? DFS or BFS ? If the file content is very
 *         large (GB level), how will you modify your solution? If you can only
 *         read the file by 1kb each time, how will you modify your solution?
 ...
 *         optimize? How to make sure the duplicated files you find are not
 *         false positive?
 *
 */
public class SolutionDay04_L0609 {
	...
	public static void main(String[] args) {
		SolutionDay04_L0609 day = new SolutionDay04_L0609();
